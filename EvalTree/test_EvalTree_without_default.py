...
def test_arguments():
    ...
    script_path = os.path.join(path, 'src', 'evaltree',"EvalTree.py")
    input1=os.path.join(path,'tests','input1')  
    input2=os.path.join(path,'tests','input2')
    output=os.path.join(path,'tests','TEST2')
...
def test_plots_category_percentage():
    ...
    input1 = os.path.join(path,'tests', 'input1')
    input2 = os.path.join(path,'tests', 'input2')
    output = os.path.join(path,'tests', 'TEST2', 'plots_category_percentage')
...
def test_sequence_type_and_folder():
    ...
    path = os.path.dirname(main_path)  
    script_path = os.path.join(path,'src','evaltree',"EvalTree.py")
    input1 = os.path.join(path,'tests', 'input1','GT_1.tsv')
    input2 = os.path.join(path,'tests', 'input2')
    output = os.path.join(path,'tests', 'TEST2', 'st_vs_folder')
...
def mx_partition_vs_mx_partitions():
    ...
    path = os.path.dirname(main_path)  
    script_path = os.path.join(path, 'src', 'evaltree' ,"EvalTree.py")
    input1 = os.path.join(path,'tests','input1' ,'GT_partitions.tsv')
    input2 = os.path.join(path,'tests', 'input2' ,'HC_partitions.tsv')
    output = os.path.join(path,'tests', 'TEST2', 'mx_vs_mx')
...
def test_plots_category_number():
    ...
    input1 = os.path.join(path,'tests', 'input1')
    input2 = os.path.join(path,'tests', 'input2')
    output = os.path.join(path,'tests', 'TEST2', 'plots_category_number')
...
def test_folder_vs_folder():
    ...
    input1 = os.path.join(path,'tests', 'input1')
    input2 = os.path.join(path,'tests', 'input2')
    output = os.path.join(path,'tests', 'TEST2', 'folder_vs_folder')
...
def test_file_vs_folder():
    ...
    script_path = os.path.join(path,'src','evaltree', "EvalTree.py")
    input1 = os.path.join(path,'tests', 'input1')
    input2 = os.path.join(path,'tests', 'input2','HC_2.tsv')
    output = os.path.join(path,'tests', 'TEST2', 'file_vs_folder')
...
def test_file_vs_file():
    ...
    input1 = os.path.join(path,'tests', 'input1','GT_1.tsv')
    input2 = os.path.join(path,'tests', 'input2','HC_2.tsv')
    output = os.path.join(path,'tests', 'TEST2', 'file1_vs_file2')
...
def test_file_mx_partition():
    ...
    input1 = os.path.join(path,'tests', 'input1','GT_1.tsv')
    input2 = os.path.join(path,'tests', 'input2','HC_partitions.tsv')
    output = os.path.join(path,'tests', 'TEST2', 'file_vs_file')
